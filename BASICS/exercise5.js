...
const arrayForUserNames = [];
const newArray = array.forEach((user) =>{
  arrayForUserNames.push(user.username + '!');
});

console.log('userArray', arrayForUserNames);
...
const accumArray = array.reduce((accum, num) => {
   return accum + num.score;
},0);

console.log('reduceArray', accumArray);
